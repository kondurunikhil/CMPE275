...
public final class RouteServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<route.HeartBeat,
      route.HeartBeat> getHeartbeatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "heartbeat",
      requestType = route.HeartBeat.class,
      responseType = route.HeartBeat.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<route.HeartBeat,
      route.HeartBeat> getHeartbeatMethod() {
    io.grpc.MethodDescriptor<route.HeartBeat, route.HeartBeat> getHeartbeatMethod;
    if ((getHeartbeatMethod = RouteServiceGrpc.getHeartbeatMethod) == null) {
      synchronized (RouteServiceGrpc.class) {
        if ((getHeartbeatMethod = RouteServiceGrpc.getHeartbeatMethod) == null) {
          RouteServiceGrpc.getHeartbeatMethod = getHeartbeatMethod =
              io.grpc.MethodDescriptor.<route.HeartBeat, route.HeartBeat>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "heartbeat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  route.HeartBeat.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  route.HeartBeat.getDefaultInstance()))
              .setSchemaDescriptor(new RouteServiceMethodDescriptorSupplier("heartbeat"))
              .build();
        }
      }
    }
  ...
  public static abstract class RouteServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void heartbeat(route.HeartBeat request,
        io.grpc.stub.StreamObserver<route.HeartBeat> responseObserver) {
  ...
  public static final class RouteServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<RouteServiceBlockingStub> {
    ...
    /**
     */
    public route.HeartBeat heartbeat(route.HeartBeat request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class RouteServiceFutureStub extends io.grpc.stub.AbstractFutureStub<RouteServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<route.HeartBeat> heartbeat(
        route.HeartBeat request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_HEARTBEAT:
          serviceImpl.heartbeat((route.HeartBeat) request,
              (io.grpc.stub.StreamObserver<route.HeartBeat>) responseObserver);
          break;
        default:
